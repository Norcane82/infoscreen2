...
function isAdminPage(string $current, string $target): string {
...
<title>Infoscreen 2 Master Verwaltung</title>
...
<header class="masterHeader">
    <div>
        ...
        <h1>Master Verwaltung</h1>
        <p class="small">Zentrale Verwaltung für Player, Status, Uploads, Playlist, Backups und Systemaktionen.</p>
    </div>
    <div class="systemSwitcher">
        <label for="targetSystem">Aktiver Player / Zielsystem</label>
        <select id="targetSystem" name="targetSystem" disabled>
            <option selected>Infoscreen 2 – Lokal</option>
        </select>
...
<?php if ($page === 'master'): ?>
    <div class="card">
        <div class="cardHeader">
            <div>
                <h2>Hauptbereiche</h2>
                <p class="small">Jeder Bereich öffnet eine kleinere Verwaltungsseite. Bestehende Funktionen bleiben unverändert.</p>
            </div>
        </div>
        ...
        <div class="masterGrid">
            ...
            <a class="masterTile" href="admin.php?page=playlist">
    ...
    <div class="card">
        <div class="cardHeader">
            <div>
                ...
                <p class="small">Häufige Wartungsaktionen. Kritische Funktionen sind weiterhin getrennt geschützt.</p>
            </div>
        </div>
...
<?php if ($page === 'fallback'): ?>
    <div class="card">
        <h2>Fallback</h2>
        <div class="statusGrid">
            <div class="statusTile">
                <span class="statusTile__label">Aktueller Status</span>
                <span class="badge <?= !empty($health['fallback_active']) ? 'off' : 'ok' ?>">
                    <?= !empty($health['fallback_active']) ? 'Fallback aktiv' : 'Normaler Player' ?>
                </span>
            </div>
            <div class="statusTile">
                <span class="statusTile__label">Angeforderte Ansicht</span>
                <span class="statusTile__value"><code><?= h((string)($health['requested_view'] ?? 'index')) ?></code></span>
            </div>
        </div>
...
<?php if ($page === 'backups'): ?>
    <div class="card">
        <h2>Backups</h2>
        <p class="small">Backup-Verwaltung öffnen oder direkt ein neues Backup erstellen.</p>
        <div class="actions">
            <a class="btn secondary" href="backups.php">Backups anzeigen</a>
            <form action="backup.php" method="post">
                <button class="secondary" type="submit">Backup erstellen</button>
            </form>
        </div>
...
<?php if ($page === 'critical'): ?>
    <div class="card card--danger">
        <h2>Kritische Aktionen</h2>
        <p class="criticalHint">
        ...
        <details class="criticalPanel" open>
...
<?php if ($page === 'playlist' || $page === 'upload'): ?>
    <div class="card">
        <div class="cardHeader">
            <div>
                <h2>Playlist</h2>
